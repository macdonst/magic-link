...
await db.set({ table: 'roles', key: 'r1', name: 'admin', description: '', rules: {
  action_1: 'create', target_1: 'users', owner_1: 'SELF', id_1: '',
  action_2: 'read', target_2: 'users', owner_2: 'SELF', id_2: '',
  action_3: 'update', target_3: 'users', owner_3: 'SELF', id_3: '',
  action_4: 'delete', target_4: 'users', owner_4: 'SELF', id_4: '',
} })
